...
import { useDeleteProductsMutation, useFetchAllProductsQuery } from '../../../../redux/features/products/productsApi.js';
...
const ManageProduct = () => {
    ...
    const handleDeleteProduct = async (id) => {
        try {
            const response = await deleteProducts(id).unwrap();
