...
import { useDeleteOrderMutation, useGetAllOrdersQuery } from '../../../../redux/features/orders/orderApi.js';
import { fromateDate } from '../../../../utils/formateDate.js';
                ...
                <tbody>
                    {
                        orders && orders.map((order, index) => (
                            <tr key={index}>
                                ...
                                <td className='py-3 px-4 border-b'>{fromateDate(order?.updatedAt)}</td>
                                <td className='py-3 px-4 border-b flex items-center space-x-4 mt-6'>
